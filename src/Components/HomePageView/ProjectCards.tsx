...
const ProjectCards = ({imageUrl,title,text,handleProjectButtonClick,routerPage}:{imageUrl:string,title:string,text:string,handleProjectButtonClick:Function,routerPage:string}) => {
    return(
        ...
        <Card.Text>
        <Button onClick={()=>handleProjectButtonClick(routerPage)} onMouseEnter={(e) => {e.currentTarget.style.transform = 'scale(1.02)';}}onMouseLeave={(e) => {e.currentTarget.style.transform = 'scale(1)';}}  
